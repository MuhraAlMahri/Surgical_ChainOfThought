#!/bin/bash
#SBATCH --job-name=train_medgemma_kvasir
#SBATCH --output=slurm/logs/train_medgemma_kvasir_%j.out
#SBATCH --error=slurm/logs/train_medgemma_kvasir_%j.err
...
# Configuration
BASE_CHECKPOINT="${SLURM_SUBMIT_DIR}/corrected_1-5_experiments/qlora_experiments/models/medgemma_kvasir_instruction/best_model"
...
OUTPUT_DIR="${SLURM_SUBMIT_DIR}/results/medgemma_kvasir_cot_5epochs"
