#!/bin/bash
#SBATCH --job-name=qwen3vl_kvasir_cot
#SBATCH --output=slurm/logs/qwen3vl_kvasir_cot_%j.out
#SBATCH --error=slurm/logs/qwen3vl_kvasir_cot_%j.err
...
echo "================================================"
echo "Training: Qwen3-VL on Kvasir with Multi-Head CoT"
echo "Start: $(date)"
echo "================================================"
