"""
Evaluate Exp2 checkpoint-642 predictions
"""
import json
import re
...
def evaluate(pred_path):
    ...
    print("="*80)
    print("EXP2 EVALUATION - Checkpoint 642 (Qwen Reordered)")
    print("="*80)
...
if __name__ == "__main__":
    ...
    pred_file = script_dir / "outputs/predictions_checkpoint642.jsonl"
    ...
    if not pred_file.exists():
        ...
        # Save results
        output = script_dir / "outputs/eval_checkpoint642.json"
