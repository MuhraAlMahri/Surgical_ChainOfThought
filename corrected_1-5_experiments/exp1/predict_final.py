"""
Generate predictions using Exp1 final checkpoint (2.5 epochs, full resolution)
Uses test set for evaluation - automatically finds latest checkpoint
"""
import os
import sys
import json
...
def find_latest_checkpoint(output_dir):
    ...
    if not checkpoints:
        # Maybe the final model is saved directly
...
def main():
    ...
    # Use checkpoint-6000 (2.34 epochs - 93.5% complete)
    checkpoint_dir = script_dir / "outputs/checkpoint-6000"
    ...
    print("="*80)
    print("EXP1 PREDICTION - Checkpoint-6000 (Full Resolution, 2.34 Epochs)")
    print("="*80)
    ...
    # Save predictions
    output_file = checkpoint_dir / "predictions_final.jsonl"
